...
from optimise.optim_multiple import optim_real_data
#from optimise.optim_multiple_headless import optim_real_data
...
if __name__ == '__main__':
    ...
    if args.gender == 'male':
        args.pose_shape_weights = "/scratches/nazgul/cq244/hkpd_depth/model_files/poseMF_shapeGaussian_net_weights_male.tar"
    if args.gender == 'female':
        args.pose_shape_weights = "/scratches/nazgul/cq244/hkpd_depth/model_files/poseMF_shapeGaussian_net_weights_female.tar"
