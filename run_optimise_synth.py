...
from train.optimise_synth_data import optimise_synth_data
...
def run_train(device,
    ...
    # Load pretrained checkpoint for optimisation initialisation
    ...
    # SMPL_300_MODEL_DIR = '/scratch/cq244/pytorch_indirect_learning/info/smpl_300'
    # num_betas = 10

    # num_simul_imgs = num_simul_subjects * num_imgs_per_subject
    # smpl_male = SMPL(SMPL_300_MODEL_DIR,
    #                 gender='male',
    #                 num_betas=num_betas).to(device)
    # smpl_female = SMPL(SMPL_300_MODEL_DIR,
    #                 gender='female',
    #                 num_betas=num_betas).to(device)
    
    num_simul_imgs = 1
    # np.array_equal(smpl_male.faces, smpl_model.faces) returns true
    ...
    optimise_synth_data(pose_shape_model=pose_shape_model,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pose_shape_weights', '-W3D', type=str, default='/scratch/cq244/HierProbHuman/model_files/poseMF_shapeGaussian_net_weights.tar')
